!function (window) {
    /*modify by sudeming remove create element by json function,so rewrite this function in your files when you want to use*/
    function Element() {
    ...
    CanvasRenderingContext2D.prototype.JTopoRoundRect = function (a, b, c, d, e) {
        ...
        MouseCursor: {
            ...
            move: "move",
            open_hand: "url(./assets/icons/openhand.cur) 8 8, default",
            closed_hand: "url(./assets/icons/closedhand.cur) 8 8, default"
        }
    ...
    function c(c) {
        ...
        }, this.toJson = function (nodeNumbers) {
            var b = this,
                c = '{"version":"' + JTopo.version + '","deviceNum":"' + nodeNumbers + '",';
    ...
    function b(c) {
        this.initialize = function (c) {
            ...
            var d = "deviceId,remark,dataType,nodeImage,text,font,fontColor,textPosition,textOffsetX,textOffsetY,borderRadius".split(",");
    ...
    function f(b, c, g) {
        ...
        /*modify by sudeming add deviceId,deviceA,deviceZ*/
        this.initialize = function (b, c, d) {
            if (f.prototype.initialize.apply(this, arguments), this.elementType = "link", this.zIndex = a.zIndex_Link, 0 != arguments.length) {
                ...
                var e = "deviceId,deviceA,deviceZ,lineType,topoLineType,text,font,fontColor,lineWidth,lineJoin".split(",");
        ...
        this.paintText = function (a, b) {
            ...
            /*modify by sudeming remove all nodes shadow*/
